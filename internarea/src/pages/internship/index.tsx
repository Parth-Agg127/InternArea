...
const index = () => {
  ...
  useEffect(()=>{
    const fetchdata=async()=>{
      try {
        const res=await axios.get( "https://internarea-1-n2uz.onrender.com/api/internship")     
          ...
          <div className="hidden md:block w-64 bg-white rounded-lg shadow-sm p-6 h-fit">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium text-black">{t("internshipPage.filters")}</span>
              </div>
              <button
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-gray-700">{t("internshipPage.workFromHome")}</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 rounded"
                  />
                  <span className="text-gray-700">{t("internshipPage.partTime")}</span>
                </label>
              </div>
          ...
          <div className="flex-1">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
              <p className="text-center font-medium text-black">
                {filteredInternships.length} {t("internshipPage.internshipsFound")}
              </p>
            </div>
              ...
              {filteredInternships.map((internship: any) => (
                ...
                >
                  <div className="flex items-center space-x-2 text-blue-600 mb-4">
                    ...
                    <span className="font-medium">{t("internshipPage.activelyHiring")}</span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6">
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <div>
                        <p className="text-sm font-medium">{t("internshipPage.startDate")}</p>
                    ...
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <div>
                        <p className="text-sm font-medium">{t("internshipPage.location")}</p>
                    ...
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <div>
                        <p className="text-sm font-medium">{t("internshipPage.stipend")}</p>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-1 text-green-600">
                        ...
                        <span className="text-sm">{t("internshipPage.postedRecently")}</span>
                      </div>
                    </div>
                    <Link
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 md:hidden">
          <div className="bg-white h-full w-full max-w-sm ml-auto p-6 overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-bold">{t("internshipPage.filters")}</h2>
              <button
